...
// ==========================================
// SALDO Y PERFIL (CORREGIDO PARA TU DB)
// ==========================================
async function cargarPerfil() {
    try {
        ...
        if (session && session.user) {
            ...
            // Consulta corregida: solo busca 'saldo' ya que no existe columna username en perfiles
    ...
    if (sharedState.gameState === 'RESOLVED' && !roundResolved) {
        ...
        setTimeout(() => { 
            if (isHost) { 
                ...
                // Limpieza absoluta de la mesa para la siguiente ronda
                sharedState.communityCards = []; 
                sharedState.dealerHand = []; 
                emitState(); 
            } 
